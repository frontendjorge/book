export default [{
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 1o. OBJETO. ',
    text: 'La presente ley tiene como objeto fijar los criterios que deben servir de base para regular los contratos de arrendamiento de los inmuebles urbanos destinados a vivienda, en desarrollo de los derechos de los colombianos a una vivienda digna y a la propiedad con función social.'
  } 
},
{
  id: 2,
...
},
{
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 5o. TÉRMINO DEL CONTRATO.',
    text: 'El término del contrato de arrendamiento será el que acuerden las partes. A falta de estipulación expresa, se entenderá por el término de un (1) año.'
  }
},
{
  id: 6,
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 6o. PRÓRROGA.',
    text: 'El contrato de arrendamiento de vivienda urbana se entenderá prorrogado en iguales condiciones y por el mismo término inicial, siempre que cada una de las partes haya cumplido con las obligaciones a su cargo y, que el arrendatario, se avenga a los reajustes de la renta autorizados en esta ley.'
  }
},
{
  id: 7,
...
},
{
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 19 FIJACIÓN DEL CANON DE ARRENDAMIENTO.',
    text: 'El precio mensual del canon estipulado por las partes, puede ser fijado en cualquier moneda o divisa extranjera, pagándose en moneda legal colombiana a la tasa de cambio representativa del mercado en la fecha en que fue contraída la obligación, salvo que las partes hayan convenido una fecha o tasa de referencia diferente.'
  }
},
{
  id: 20,
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 20 REAJUSTE DEL CANON DE ARRENDAMIENTO.',
    text: 'Cada doce (12) meses de ejecución del contrato bajo un mismo precio, el arrendador podrá incrementar el canon hasta en una proporción que no sea superior al ciento por ciento (100%) del incremento que haya tenido el índice de precios al consumidor en el año calendario inmediatamente anterior a aquél en que deba efectuarse el reajuste del canon, siempre y cuando el nuevo canon no exceda lo previsto en el artículo 18 de la presente ley. El arrendador que opte por incrementar el canon de arrendamiento, deberá informarle al arrendatario el monto del incremento y la fecha en que se hará efectivo, a través del servicio postal autorizado o mediante el mecanismo de notificación personal expresamente establecido en el contrato, so pena de ser inoponible al arrendatario. El pago por parte del arrendatario de un reajuste del canon, no le dará derecho a solicitar el reintegro, alegando la falta de la comunicación.'
  }
},
{
  id: 21,
  chapter: 'CAPITULO VII',
  title: 'TERMINACIÓN DEL CONTRATO DE ARRENDAMIENTO',
  notes: null,
  article: {
    name: 'ARTÍCULO 21. TERMINACIÓN POR MUTUO ACUERDO.',
    text: 'Las partes, en cualquier tiempo, y de común acuerdo podrán dar por terminado el contrato de vivienda urbana.'
  }
},
{
  id: 22,
...
},
{
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 26. DERECHO DE RETENCIÓN.',
    text: 'En todos los casos en los cuales el arrendador deba indemnizar al arrendatario, éste no podrá ser privado del inmueble arrendado sin haber recibido el pago previo de la indemnización correspondiente o sin que se le hubiere asegurado debidamente el importe de ella por parte del arrendador.'
  }
},
{
  id: 27,
...
},
{
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 29. REQUISITOS PARA OBTENER LA MATRÍCULA.',
    text: 'Para obtener la matrícula de arrendador, el interesado deberá cumplir los siguientes requisitos: a) Presentar documento que acredite existencia y representación legal, cuando se trate de personas jurídicas. En el caso de personas naturales, el registro mercantil; b) Presentar el modelo o modelos de los contratos de arrendamientos, y los de administración que utilizarán en desarrollo de su actividad; c) Las demás que determine la autoridad competente.'
  }
},
{
  id: 30,
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 30. TÉRMINO PARA SOLICITAR LA MATRÍCULA.',
    text: 'Las personas a que se refiere el artículo 28 que no se encuentren registradas ante la autoridad competente, deberán hacerlo a más tardar dentro de los tres (3) meses siguientes contados a partir de la fecha de vigencia de la presente ley. Quienes ya se encuentren inscritos, deberán igualmente actualizar los datos señalados en el artículo anterior, dentro del mismo término. Las personas naturales o jurídicas que con posterioridad a la presente ley se ocupen del arrendamiento de bienes raíces urbanos ajenos, deberán registrarse dentro de los diez (10) días siguientes a la iniciación de sus operaciones.'
  }
},
{
  id: 31,
  ...
  notes: null,
  article: {
    name: 'ARTÍCULO 31. CONDICIÓN PARA ANUNCIARSE COMO ARRENDADOR.',
    text: 'Para anunciarse al público como arrendador, las personas a que se refiere el artículo 28 de la presente ley deberán indicar el número de su matrícula vigente. Esta obligación será exigible a partir del vencimiento de los términos señalados en el artículo anterior, según corresponda.'
  }
},
{
  id: 32,
  chapter: 'CAPITULO IX',
  title: 'INSPECCIÓN, CONTROL Y VIGILANCIA EN MATERIA DE ARRENDAMIENTOS',
  notes: null,
  article: {
    name: 'ARTÍCULO 32. INSPECCIÓN, CONTROL Y VIGILANCIA DE ARRENDAMIENTO.',
    text: 'La inspección, control y vigilancia, estarán a cargo de la Alcaldía Mayor de Bogotá, D. C., la Gobernación de San Andrés, Providencia y Santa Catalina y las alcaldías municipales de los municipios del país. PARÁGRAFO. Para los efectos previstos en la presente ley, la Alcaldía Mayor de Bogotá, D. C., establecerá la distribución funcional que considere necesaria entre la subsecretaría de control de vivienda, la secretaría general y las alcaldías locales.'
  }
},
{
  id: 33,
...
},
{
  ...
  chapter: null,
  title: null,
  notes: '- Artículo derogado por el literal c) del artículo 626 de la Ley 1564 de 2012, "por medio de la cual se expide el Código General del Proceso y se dictan otras disposiciones", publicada en el Diario Oficial No. 48.489 de 12 de julio de 2012. La derogatoria rige a partir del 1o. de enero de 2014, en los términos del numeral 6) del artículo 627. Corte Constitucional - La Corte Constitucional declaró estarse a lo resuelto en la Sentencia C-670-04, mediante Sentencia C-886-04 de 14 de septiembre de 2004, Magistrado Ponente Dr. Manuel José Cepeda. - Artículo declarado EXEQUIBLE por la Corte Constitucional mediante Sentencia C-670-04 de 13 de julio de 2004, Magistrada Ponente Dra. Clara Inés Vargas Hernández. Texto original de la Ley 820 de 2003: ARTÍCULO 38. En ningún caso, las sentencias proferidas en procesos de restitución de inmueble arrendado serán consultadas.',
  article: {
    name: 'ARTÍCULO 38. CONSULTA.',
    text: '<Artículo derogado por el literal c) del artículo 626 de la Ley 1564 de 2012. Rige a partir del 1o. de enero de 2014. En los términos del numeral 6) del artículo 627, ver en Legislación Anterior el texto vigente hasta esta fecha>'
  }
},
{
  ...
  chapter: null,
  title: null,
  notes: '- Artículo derogado por el literal c) del artículo 626 de la Ley 1564 de 2012, "por medio de la cual se expide el Código General del Proceso y se dictan otras disposiciones", publicada en el Diario Oficial No. 48.489 de 12 de julio de 2012. La derogatoria rige a partir del 1o. de enero de 2014, en los términos del numeral 6) del artículo 627. Corte Constitucional - Inciso 1o. declarado CONDICIONALMENTE exequible por la Corte Constitucional mediante Sentencia C-886-04 de 14 de septiembre de 2004, Magistrado Ponente Dr. Manuel José Cepeda, "... en el entendido que el trámite preferente establecido en los procesos de restitución de inmueble arrendado, ha de operar sin perjuicio de la prevalencia de las acciones de estirpe constitucional". Estarse a lo resuelto en la Sentencia C-670-04 - Inciso 2o. declarado EXEQUIBLE por la Corte Constitucional mediante Sentencia C-670-04 de 13 de julio de 2004, Magistrada Ponente Dra. Clara Inés Vargas Hernández.  INHIBIDA de fallar sobre el inciso 1o. por ineptitud de la demanda. Texto original de la Ley 820 de 2003: ARTÍCULO 39. <Inciso 1o. CONDICIONALMENTE exequible> Todos los procesos de restitución de inmueble arrendado tendrán trámite preferente, salvo respecto de los de tutela. Su inobservancia hará incurrir al juez o funcionario responsable en causal de mala conducta sancionable con destitución del cargo. El Consejo Superior de la Judicatura adoptará las normas necesarias para el cumplimiento de lo así dispuesto, dentro de los seis (6) meses siguientes a la vigencia de la presente ley. Cuando la causal de restitución sea exclusivamente mora en el pago del canon de arrendamiento, el proceso se tramitará en única instancia.',
  article: {
    name: 'ARTÍCULO 39. TRÁMITE PREFERENTE Y ÚNICA INSTANCIA.',
    text: '<Artículo derogado por el literal c) del artículo 626 de la Ley 1564 de 2012. Rige a partir del 1o. de enero de 2014. En los términos del numeral 6) del artículo 627, ver en Legislación Anterior el texto vigente hasta esta fecha>'
  }
},
